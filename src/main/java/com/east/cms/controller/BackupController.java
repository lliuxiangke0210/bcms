...
public class BackupController {
	...
	public String backup() {// oo
		return "backup/add";
	}

	@RequestMapping(value = "/backup/add", method = RequestMethod.POST)
	public String backup(String backupFilename) {// oo
	...
	public String list(Model model) {// oo
		BackupFileUtil bfu = BackupFileUtil.getInstance(SystemContext.getRealPath());
	...
	public String delete(@PathVariable String name, String type) {// oo
		BackupFileUtil bfu = BackupFileUtil.getInstance(SystemContext.getRealPath());
