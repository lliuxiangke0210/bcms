...
import com.east.cms.dao.IndexPicMapper;
...
public class IndexPicServiceImpl implements IndexPicService {
	@Autowired
	private IndexPicMapper indexPicDao;
	...
	public PageInfo<IndexPic> findIndexPic() {
		...
		List<IndexPic> indexPics = indexPicDao.findIndexPic();
		PageInfo<IndexPic> page = new PageInfo<IndexPic>(indexPics);
		return page;
	}
